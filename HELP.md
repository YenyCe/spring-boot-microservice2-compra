...
* The original package name 'com.yeny.spring-boot-microservice2-compra' is invalid and this project uses 'com.yeny.spring_boot_microservice2_compra' instead.
